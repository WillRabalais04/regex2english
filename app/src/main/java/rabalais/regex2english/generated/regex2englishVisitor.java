...
public interface regex2englishVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link regex2englishParser#doubleBoundaryMatchers}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDoubleBoundaryMatchers(regex2englishParser.DoubleBoundaryMatchersContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link regex2englishParser#endOfInput}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEndOfInput(regex2englishParser.EndOfInputContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link regex2englishParser#extra_letters_allowed_inside_CC}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExtra_letters_allowed_inside_CC(regex2englishParser.Extra_letters_allowed_inside_CCContext ctx);
}