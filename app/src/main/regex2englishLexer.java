...
public class regex2englishLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CARET", "LETTER", "EXTRA_LETTER_ALLOWED_INSIDE", "LETTER_RANGE", "NUMBER_RANGE", 
			...
			"HYPHEN_ESCAPED", "LBRACKET", "RBRACKET", "LPAREN", "RPAREN", "RANGE_QUANTIFIER", 
			"MIN_QUANTIFIER", "PLUS", "ASTERISK", "QMARK", "PIPE", "BACKSLASH", "OCTAL_1", 
			...
			"UNICODE_CLASS_NOT_UC", "NEWLINE_REF", "NAMED_CAPTURE_GROUP_MATCH"
		};
	}
